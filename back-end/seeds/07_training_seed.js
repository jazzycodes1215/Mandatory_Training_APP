...
exports.seed = async function(knex) {
  ...
  await knex('trainings').insert([
    ...
    {name: 'Controlled Unclassified Information (CUI) Training', interval: 365, source: 'source', type_id: 2},
    ...
    {name: 'Sexual Assault prevention', interval: 365, source: 'SEE SAPR POC', type_id: 2},
