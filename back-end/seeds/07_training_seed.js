...
exports.seed = async function(knex) {
  ...
  await knex('trainings').insert([
    ...
    {id: 7, name: 'Escort Training', interval: 360, source: 'source', type_id: 2},
    {id: 8, name: 'SERE CBT', interval: null, source: 'source', type_id: 2},
    {id: 9, name: 'Sexual assaut prevention', interval: 360, source: 'source', type_id: 2},
    {id: 10, name: 'Suicide Awareness', interval: 360, source: 'source', type_id: 2},
    {id: 11, name: 'Self aid buddy Care', interval: 360, source: 'source', type_id: 2},
    {id: 12, name: 'Insider Threat', interval: 360, source: 'source', type_id: 2},
    ...
    {id: 24, name: 'Unit Fitness Program Management Training', interval: 360, source: 'source', type_id: 4},
